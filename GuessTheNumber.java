	...
	public boolean isCorrectGuess() {
		...
		if ( systemInput == userInput ) {
			...
			switch(noOfGuesses) {
				...
				break;
				case 2:
				System.out.println("Congrats, Your score is 90");
				break;
				case 3:
				System.out.println("Congrats, Your score is 80");
				break;
				case 4:
				System.out.println("Congrats, Your score is 70");
				break;
				case 5:
				System.out.println("Congrats, Your score is 60");
				break;
				case 6:
				System.out.println("Congrats, Your score is 50");
				break;
				case 7:
				System.out.println("Congrats, Your score is 40");
				break;
				case 8:
				System.out.println("Congrats, Your score is 30");
				break;
				case 9:
				System.out.println("Congrats, Your score is 20");
				break;
				case 10:
				System.out.println("Congrats, Your score is 10");
				break;
			}
			System.out.println();
			return true;
